...
// Routes
app.use("/api/auth", userRoutes); // Routes d'authentification et de gestion de profil
app.use("/api/appointments", appointmentRoutes); // Routes de gestion des rendez-vous
